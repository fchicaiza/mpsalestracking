<html lang="en">
    <head>
        ...
        <!-- Normalize -->
        <link rel="stylesheet" type="text/css" href="../public/css/css/normalize.css">
        <!-- Bootstrap -->
        <link rel="stylesheet" type="text/css" href="../public/css/css/bootstrap.css">
        <!-- Owl -->
        <link rel="stylesheet" type="text/css" href="../public/css/css/owl.css">
        <!-- Animate.css -->
        <link rel="stylesheet" type="text/css" href="../public/css/css/animate.css">
        <!-- Font Awesome -->
        <link rel="stylesheet" type="text/css" href="../public/fonts/fonts/font-awesome-4.1.0/css/font-awesome.min.css">
        <!-- Elegant Icons -->
        <link rel="stylesheet" type="text/css" href="../public/fonts/fonts/eleganticons/et-icons.css">
        <!-- Main style -->
        <link rel="stylesheet" type="text/css" href="../public/css/css/cardio.css">
    </head>

    <body>
        <div class="preloader">
            <img src="../files/img/loader.gif" alt="Preloader image">
        </div>
        <nav class="navbar">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="../files/img/logo.png" data-active-url="../files/img/logo-active.png" alt=""></a>
                </div>
            ...
            <div class="container">
                ...
                <div class="row services">
                    <div class="col-md-4">
                        <div class="service">
                            <div class="icon-holder">
                                <img src="../files/img/icons/heart-blue.png" alt="" class="icon">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="service">
                            <div class="icon-holder">
                                <img src="../files/img/icons/guru-blue.png" alt="" class="icon">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="service">
                            <div class="icon-holder">
                                <img src="../files/img/icons/weight-blue.png" alt="" class="icon">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="team text-center">
                            <div class="cover" style="background:url('../files/img/team/team-cover1.jpg'); background-size:cover;">
                                <div class="overlay text-center">
                                    <h3 class="white">$69.00</h3>
                                    <h5 class="light light-white">1 - 5 sessions / month</h5>
                                </div>
                            </div>
                            <img src="../files/img/team/team3.jpg" alt="Team Image" class="avatar">
                            <div class="title">
                                <h4>Ben Adamson</h4>
                    ...
                    <div class="col-md-4">
                        <div class="team text-center">
                            <div class="cover" style="background:url('../files/img/team/team-cover2.jpg'); background-size:cover;">
                                <div class="overlay text-center">
                                    <h3 class="white">$69.00</h3>
                                    <h5 class="light light-white">1 - 5 sessions / month</h5>
                                </div>
                            </div>
                            <img src="../files/img/team/team1.jpg" alt="Team Image" class="avatar">
                            <div class="title">
                                <h4>Eva Williams</h4>
                    ...
                    <div class="col-md-4">
                        <div class="team text-center">
                            <div class="cover" style="background:url('../files/img/team/team-cover3.jpg'); background-size:cover;">
                                <div class="overlay text-center">
                                    <h3 class="white">$69.00</h3>
                                    <h5 class="light light-white">1 - 5 sessions / month</h5>
                                </div>
                            </div>
                            <img src="../files/img/team/team2.jpg" alt="Team Image" class="avatar">
                            <div class="title">
                                <h4>John Phillips</h4>
                                <h5 class="muted regular">Personal Trainer</h5>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row no-margin">
                    <div class="col-md-7 no-padding col-md-offset-5 pricings text-center">
                        <div class="pricing">
                            <div class="box-main active" data-img="../files/img/pricing1.jpg">
                        ...
                        <div class="pricing">
                            <div class="box-main" data-img="../files/img/pricing2.jpg">
        ...
        <!-- Scripts -->
        <script src="../public/js/js/jquery-1.11.1.min.js"></script>
        <script src="../public/js/js/owl.carousel.min.js"></script>
        <script src="../public/js/js/bootstrap.min.js"></script>
        <script src="../public/js/js/wow.min.js"></script>
        <script src="../public/js/js/typewriter.js"></script>
        <script src="../public/js/js/jquery.onepagenav.js"></script>
